...
export function Actions({
   ...
   needToAccept = needToAccept.sort((a, b) =>
      Number(a.id) < Number(b.id) ? -1 : 1
   );
   ...
   return (
      <div className='w-full space-y-8'>
         <div>
            <div className='max-w-[450px] text-neutral-600 mb-3'>
               These proposals need action - you should claim the admin role for
               yourself or transfer it to someone else.
            </div>
            <div>
               {needToClaim.map((a, i) => (
                  <div
                  ...
                  >
                     ...
                     <Link
                        href={`/admin/${a.id}`}
                        className='bg-blue-500 border-blue-600 border-[1px] hover:opacity-90 transition-all ease-in-out shadow-sm rounded-lg py-[2px] px-[14px] text-white'
                     >
                        Claim
                     </Link>
                  </div>
